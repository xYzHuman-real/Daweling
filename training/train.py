...
def train(text_path: Path | None, output_path: Path, steps: int, learning_rate: float, *, seed=0, dataset_manifest_path=None, validation_text_path=None, dataset_path=None, validation_ratio=0.1, split_seed=0, batch_size=1, validation_interval=10, resume_from=None, best_output_path=None, warmup_steps=0, min_learning_rate=0.0, gradient_accumulation_steps=1):
